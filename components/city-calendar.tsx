...
interface CityCalendarProps {
  centerName: string
  dates: BookingDate[]
  onDateSelect: (date: string, city: string) => void
  isLoading?: boolean
  selectedDate?: { date: string; city: string } | null
}

export function CityCalendar({ centerName, dates, onDateSelect, isLoading, selectedDate }: CityCalendarProps) {
  ...
  const handleDateClick = (date: Date | undefined) => {
    if (date && isDateAvailable(date)) {
      ...
      onDateSelect(dateString, centerName)
    }
  }
